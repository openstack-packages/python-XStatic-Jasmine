...
Version:        XXX
Release:        1%{?dist}
Summary:        Jasmine JavaScript library packaged for setuptools

License:        MIT
URL:            http://git.openstack.org/cgit/stackforge/xstatic-jasmine/
...
%description
Jasmine javascript library packaged for
...
%{python_sitelib}/xstatic/pkg/jasmine
